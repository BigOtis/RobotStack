...
[![Codex Skill](https://img.shields.io/badge/Codex-Skill-blue.svg)](./src/template/SKILL.md)
...
![Agent guided deployment flow](./src/template/assets/agent-to-cloud.svg)
...
![Prescriptive MongoDB and Google Cloud stack](./src/template/assets/prescriptive-stack.svg)

## 💸 Why It Saves Money

![Cost control for agent-built sites](./src/template/assets/cost-control.svg)
...
The main skill file is [SKILL.md](./src/template/SKILL.md).
...
1. Copy the operating guidance from [SKILL.md](./src/template/SKILL.md) into your project rules, or reference this folder from your existing Cursor rules.
